    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                ...
                name='max_capacity__gt_0'
            ),
            models.CheckConstraint(
                check=models.Q(current_capacity__gte=0) & models.Q(
                    current_capacity__lte=models.F('max_capacity')),
                name='current_capacity_valid'),
            models.UniqueConstraint(
                fields=['store', 'material'],
                name='unique_store_material'
            )
        ]
